...
class CheckboxDemo01 extends Component {
  ...
  checkAll = (e) => {
    this.setState({
      ...
      checkedCompanyList: e.target.checked ? ['c1', 'c2', 'c3', 'p1', 'p2', 'p3', 'p4', 'p5'] : [],
      checkedProductList: e.target.checked ? ['p1', 'p2', 'p3', 'p4', 'p5'] : [],
    })
  }
  ...
  checkCompany = (e) => {
    ...
    console.log('=======>>checkCompany:', e.target.value)
    this.setState({
      checkAll:_checkedCompanyList.length === 3 ? true :false,
      checkedCompanyList: _checkedCompanyList,
      checkedProductList: _checkedCompanyList.length === 3 ? ['p1', 'p2', 'p3', 'p4', 'p5'] : [],
    })
  }
      ...
      <div>
        ...
        <CheckboxGroup value={this.state.checkedCompanyList}>
          <div>
            ...
            <CheckboxGroup value={this.state.checkedProductList} onChange={(checkedList) =>this.checkProduct(checkedList,'c1111')} >
          ...
          <div>
            ...
            <CheckboxGroup value={this.state.checkedProductList} onChange={this.checkProduct} >
              <Checkbox value='p3'>p3</Checkbox>
              <Checkbox value='p4'>p4</Checkbox>
            </CheckboxGroup>
          </div>
          <div>
            <Checkbox value='c3' onChange={this.checkCompany}>
              company3
            </Checkbox>
            <CheckboxGroup value={this.state.checkedProductList} onChange={this.checkProduct} >
              <Checkbox value='p5'>p5</Checkbox>
            </CheckboxGroup>
          </div>
